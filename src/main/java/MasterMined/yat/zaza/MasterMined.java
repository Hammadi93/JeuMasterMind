...
public class MasterMined {
	...
	public int rightPlaceRemove(List<String> givenCouleurs) {
		int compteur = 0;
	...
	public int existDeferentPlace(List<String> givenCouleurs) {
		int compteur = 0;
	...
	public int[] compareCombinaison(String[] givenArrayCouleurs) {
		...
		return new int[] { this.rightPlaceRemove(givenCouleurs), this.existDeferentPlace(givenCouleurs) };
	}
